...
const App_1 = __webpack_require__(/*! ./page/App */ "./src/page/App.tsx");
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
const header_1 = __webpack_require__(/*! ./header */ "./src/page/header.tsx");
let list = [{
        type: 'Header',
        content: 'xxxx'
    }];
...
function App() {
    return React.createElement("div", null, list.map((items, i) => {
        const Tel = Obj[items.type];
        return React.createElement(header_1.Header, Object.assign({ key: i }, items));
    }));
}
exports.App = App;
